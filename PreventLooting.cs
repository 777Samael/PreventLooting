...
namespace Oxide.Plugins
{
    ...
    class PreventLooting : RustPlugin
    {
        ...
        bool CheckRackedWeapon(BasePlayer player, BaseEntity entity)
        {
        ...
        object CanPickupEntity(BasePlayer player, BaseCombatEntity ent)
        {
        ...
        {
            if (args[0].Length < 4 || (args[0].StartsWith("765611") && args[0].Length < 17))
            {
                SendReply(player, lang.GetMessage("InvalidSearch", this, player.UserIDString));
                return null;
            }
